...
blk = np.array(["Block-1", "Block-2","Block-11","Block-22", "Block-33","Block-99","Block-3"])
#blk = df.Block.unique()
...
def load_data():    
    ...
    print(plant)
    #currentPlant = "Pvform1"   
    #print("3_",currentPlant) 
    df = client.query(selectQuery).to_dataframe()  
    blk1 = df.Block.unique()
    #blk1.jsonify()
    print(blk1)
...
<body>
    ...
    <select class="dropdown" id="plantDropdown" onchange="selectPlant()">
        <option value="Pvform1">Pvform1</option>
        <option value="Pvform2">Pvform2</option>
        <option value="Pvform3">Pvform3</option>
        <option value="Pvform4">Pvform4</option>
    </select>
   ...
   let currentPlant = '';
    ...
    function selectPlant() {
        ...
        console.log("1_",currentPlant)
        load_Data();
        console.log("2_",currentPlant)
        }
